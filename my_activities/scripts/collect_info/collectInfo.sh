...
# Description: This script collects system information including hostname, VRX status,
# OS version, vendor info, CPU details, memory, disk info, and network ports.
